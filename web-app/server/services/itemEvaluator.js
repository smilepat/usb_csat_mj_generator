...
1. 정답이 지문 전체 논지와 일치하는가?
2. 정답이 지문 일부 문장만 맞추는 "부분정답"이 아닌가?
3. 정답이 지문 표현을 그대로 베끼지 않고 패러프레이즈 되었는가?

## B. 오답 설계 품질 (Distractor Quality) - 25점
1. 오답이 "그럴듯한 매력"을 가지고 있는가?
2. 오답이 핵심 주제와 관련있되, 방향이 다른가?
3. 오답이 너무 뻔하게 틀리지 않는가?
4. 모든 오답이 서로 다른 오류 유형인가? (지엽정보, 과잉해석, 무관 등)

## C. 변별력 (Discrimination) - 20점
1. 정답이 너무 뻔하게 쉽지 않은가?
2. 오답 중 "바로 제거"되는 약한 선택지가 있는가?
3. 정답 후보가 2개 이상으로 보이는 "복수정답" 위험이 있는가?

## D. 문항 유형 적합성 (Type Appropriateness) - 15점
1. 해당 문항번호의 유형 특성에 맞는가?
2. 발문(question)이 문항 유형에 적절한가?
3. 선택지 형식이 유형에 맞는가?
